...
def getLayout():
    layout = [
        sg.Column(
            layout=[[sg.Text("Managing Saves",key="ManageSavesMenuTitle",font=("Helvetica", 15))],
                [sg.Button("Save Current Run", key="CreateSave", size=(28, 2)),sg.Text("Create a save using your current run")],
                [sg.Button("Update Save", key="UpdateSave", size=(28, 2)),sg.Text("Update a save using your current run")],
                [sg.Button("Load Save", key="LoadSave", size=(28, 2)),sg.Text("Load a saved run and overwrite your current run")],
                [sg.Button("Edit Save", key="EditSave", size=(28, 2)),sg.Text("Edit a saved run")],
                [sg.Button("Delete Save", key="DeleteSave", size=(28, 2)),sg.Text("Delete a saved run")],
                [sg.Button("Make Preset From Save", key="ConvertSave", size=(28, 2)),sg.Text("Create a preset based on a saved run")],
                [sg.Button("Back", key="ManageSavesMenuBack", size=(28, 2)),sg.Text("Go back to the main menu")],
            ],
            key="ManageSavesMenu",
            visible=False,
        )
